...
RESOURCES += src/qt/knoxfs.qrc src/qt/knoxfs_locale.qrc

TRANSLATIONS += src/qt/locale/knoxfs_bg.ts \
                src/qt/locale/knoxfs_de.ts \
                src/qt/locale/knoxfs_en.ts \
                src/qt/locale/knoxfs_es.ts \
                src/qt/locale/knoxfs_fi.ts \
                src/qt/locale/knoxfs_fr.ts \
                src/qt/locale/knoxfs_it.ts \
                src/qt/locale/knoxfs_ja.ts \
                src/qt/locale/knoxfs_pl.ts \
                src/qt/locale/knoxfs_pt.ts \
                src/qt/locale/knoxfs_ru.ts \
                src/qt/locale/knoxfs_sk.ts \
                src/qt/locale/knoxfs_sv.ts \
                src/qt/locale/knoxfs_vi.ts \
                src/qt/locale/knoxfs_zh_CN.ts \
                src/qt/locale/knoxfs_zh_TW.ts
