...
1. Clone the KFX Core source code:

        git clone https://github.com/knoxfs-project/knoxfs
        cd knoxfs
...
KFX Core is now available at `./src/knoxfsd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/KFX"

    touch "/Users/${USER}/Library/Application Support/KFX/knoxfs.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/KFX/knoxfs.conf"

The first time you run knoxfsd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/knoxfsd -daemon # Starts the knoxfs daemon.
    ./src/knoxfs-cli --help # Outputs a list of command-line options.
    ./src/knoxfs-cli help # Outputs a list of RPC commands when the daemon is running.
