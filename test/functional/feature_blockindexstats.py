#!/usr/bin/env python3
# Copyright (c) 2021 The KFX developers
...
class BlockIndexStatsTest(KnoxFSTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 KFX "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 KFX + 9 notes of 5 KFX + 1 note of 4 KFX (using 1.0 fee)
