...
from test_framework.test_framework import KnoxFSTier2TestFramework
...
class MasternodeGovernanceBasicTest(KnoxFSTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.knoxfs.org/t/test-proposal"
