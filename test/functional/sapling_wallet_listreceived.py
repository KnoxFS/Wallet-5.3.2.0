...
class ListReceivedTest (KnoxFSTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 KFX.
        ...
        # Send 1 KFX to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 KFX sending them all (fee is 0.1 KFX)
        ...
        # Confirm transaction (2 KFX from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 KFX, send 0.6 KFX + 0.05 KFX fee
