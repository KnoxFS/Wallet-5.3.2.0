...
"""Verify that starting knoxfs with -h works as expected."""
import subprocess

from test_framework.test_framework import KnoxFSTestFramework
from test_framework.util import assert_equal

class HelpTest(KnoxFSTestFramework):
    ...
    def run_test(self):
        self.log.info("Start knoxfs with -? for help text")
        ...
        self.log.info("Start knoxfs with -version for version information")
