...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("KnoxFS Core knoxfs-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  knoxfs-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded knoxfs transaction") + "\n" +
                               "  knoxfs-tx [options] -create [commands]   " + _("Create hex-encoded knoxfs transaction") + "\n" +
                               "\n";
