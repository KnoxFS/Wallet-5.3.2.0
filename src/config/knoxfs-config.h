/* src/config/knoxfs-config.h.  Generated from knoxfs-config.h.in by configure.  */
/* src/config/knoxfs-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/knoxfs-project/knoxfs/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "KFX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KFX Core 5.3.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "knoxfs"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://knoxfs.org/"
