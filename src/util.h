...
extern const char * const KFX_CONF_FILENAME;
extern const char * const KFX_PID_FILENAME;
extern const char * const KFX_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("knoxfs-%s", name);
