...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZknoxfs = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZknoxfs = false);
...
// Parse "knoxfs:" URI into recipient object, return true on successful parsing
