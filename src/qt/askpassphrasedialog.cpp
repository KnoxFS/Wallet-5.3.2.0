...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            KFXGUI* window = static_cast<KFXGUI*>(parentWidget());
...
{
    KFXGUI* gui = static_cast<KFXGUI*>(parentWidget());
...
{
    hide();
    static_cast<KFXGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("KFX will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your KFXs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
