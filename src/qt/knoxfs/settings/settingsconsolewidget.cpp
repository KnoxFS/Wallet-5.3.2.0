...
#include "qt/knoxfs/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/knoxfs/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(KFXGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the KFX RPC console.") + "<br>" +
