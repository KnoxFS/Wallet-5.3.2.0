...
#include "qt/knoxfs/settings/settingsnetworkwidget.h"
#include "qt/knoxfs/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/knoxfs/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(KFXGUI* _window, QWidget *parent) :
