...
#include <QWidget>
#include "qt/knoxfs/pwidget.h"
#include "qt/knoxfs/settings/settingsbackupwallet.h"
#include "qt/knoxfs/settings/settingsexportcsv.h"
#include "qt/knoxfs/settings/settingsbittoolwidget.h"
#include "qt/knoxfs/settings/settingssignmessagewidgets.h"
#include "qt/knoxfs/settings/settingswalletrepairwidget.h"
#include "qt/knoxfs/settings/settingswalletoptionswidget.h"
#include "qt/knoxfs/settings/settingsmainoptionswidget.h"
#include "qt/knoxfs/settings/settingsdisplayoptionswidget.h"
#include "qt/knoxfs/settings/settingsmultisendwidget.h"
#include "qt/knoxfs/settings/settingsinformationwidget.h"
#include "qt/knoxfs/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(KFXGUI* parent);
    ~SettingsWidget();
