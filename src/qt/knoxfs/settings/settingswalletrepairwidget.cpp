...
#include "qt/knoxfs/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/knoxfs/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(KFXGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to KFXGUI::handleRestart()
