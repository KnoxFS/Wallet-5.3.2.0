...
#include "qt/knoxfs/topbar.h"
#include "qt/knoxfs/forms/ui_topbar.h"
#include "qt/knoxfs/lockunlock.h"
#include "qt/knoxfs/qtutils.h"
#include "qt/knoxfs/receivedialog.h"
#include "qt/knoxfs/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/knoxfs/balancebubble.h"
...
TopBar::TopBar(KFXGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopKnoxFS, ui->labelAmountTopShieldedKnoxFS}, "amount-small-topbar");
    setCssProperty({ui->labelAmountKnoxFS}, "amount-topbar");
    setCssProperty({ui->labelPendingKnoxFS, ui->labelImmatureKnoxFS}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // KFX Total
    QString totalKnoxFS = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // KFX
    // Top
    ui->labelAmountTopKnoxFS->setText(totalTransparent);
    ui->labelAmountTopShieldedKnoxFS->setText(totalShielded);
    // Expanded
    ui->labelAmountKnoxFS->setText(totalKnoxFS);
    ui->labelPendingKnoxFS->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureKnoxFS->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
