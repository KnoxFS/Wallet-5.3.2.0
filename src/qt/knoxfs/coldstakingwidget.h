...
#include "qt/knoxfs/sendmultirow.h"
#include "qt/knoxfs/coldstakingmodel.h"
#include "qt/knoxfs/contactsdropdown.h"
#include "qt/knoxfs/addressholder.h"
...
public:
    explicit ColdStakingWidget(KFXGUI* parent);
    ~ColdStakingWidget();
