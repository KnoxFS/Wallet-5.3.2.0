...
#include "qt/knoxfs/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(KFXGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &KFXGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
