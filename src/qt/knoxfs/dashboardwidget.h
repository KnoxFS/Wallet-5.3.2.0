...
#include "qt/knoxfs/furabstractlistitemdelegate.h"
#include "qt/knoxfs/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/knoxfs/txviewholder.h"
...
#include "config/knoxfs-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalKnoxFS = 0;
    //qint64 totalZknoxfs = 0;
    qint64 totalMNRewards = 0;
    QList<qreal> valuesKnoxFS;
    //QList<qreal> valueszKnoxFS;
...
public:
    explicit DashboardWidget(KFXGUI* _window);
    ~DashboardWidget();
