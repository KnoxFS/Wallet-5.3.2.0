...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case KFX:
        return QString("knoxfs");
    case mKFX:
        return QString("mknoxfs");
    case uKFX:
        return QString::fromUtf8("uknoxfs");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZknoxfs)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZKFX)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZKFX);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZKFX)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZKFX));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
